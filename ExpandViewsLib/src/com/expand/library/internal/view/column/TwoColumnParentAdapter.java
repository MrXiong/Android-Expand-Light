...
public class TwoColumnParentAdapter extends ArrayAdapter<Model> {

	private Context mContext;
	private List<Model> mListData;
	private Model[] mArrayData;
	private int selectedPos = -1;
	private String selectedText = "NO_SELECTED";
	...
	public TwoColumnParentAdapter(Context context, List<Model> listData, int normalDrawbleId, int selectedDrawble) {
	...
	public TwoColumnParentAdapter(Context context, Model[] arrayData, int normalDrawbleId, int selectedDrawble) {
